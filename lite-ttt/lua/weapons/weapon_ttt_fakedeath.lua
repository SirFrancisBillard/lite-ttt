...
local explode = CreateConVar( "ttt_deathfaker_explodeondeath", 1, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "If fake bodies explode on real player death" )
local editrole = CreateConVar( "ttt_deathfaker_editrole", 1, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "If Traitors can edit their body's role, defaults to T" )
local editdeath = CreateConVar( "ttt_deathfaker_editdeathtype", 1, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "If Traitors can edit their death type, defaults Crush" )
local identify = CreateConVar( "ttt_deathfaker_identifybody", 1, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "If the fake body is automatically identified by a random player after being dropped" )
local traitoronly = CreateConVar( "ttt_deathfaker_traitoronly", 1, {FCVAR_SERVER_CAN_EXECUTE, FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Should innocents be allowed to use this weapon?" )
...
if CLIENT then
	...
	SWEP.Icon = MaterialURL("https://sirfrancisbillard.github.io/billard-radio/images/ttt/icon_hitler.png")
