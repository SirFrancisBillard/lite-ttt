...
-- spreadless shotgun, only used in the railgun power round
-- originated from a joke about how OP the default shotgun is
...
SWEP.Primary.Cone          = 0.005 -- spreadless lmao
